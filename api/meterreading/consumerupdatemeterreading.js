...
function putMeterDetailsForJobDetails(box, nextFunc) {
  ...
  var today = new Date();
  var inserting_data = {
    "new_metere_reading_error_code"   : box.reqBody.new_metere_reading_error_code ,
    "consumer_upload_picture"         : box.reqBody.consumer_upload_picture,
    "consumer_meter_reading"          : box.reqBody.consumer_meter_reading,
